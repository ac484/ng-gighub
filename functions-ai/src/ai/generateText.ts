...
import { getGenAIClient, DEFAULT_TEXT_MODEL, DEFAULT_GENERATION_CONFIG } from './client';
import type { AIGenerateTextRequest, AIGenerateTextResponse } from '../types/ai.types';
 ...
 * ```
 */
export const generateText = onCall<AIGenerateTextRequest, Promise<AIGenerateTextResponse>>(
  {
